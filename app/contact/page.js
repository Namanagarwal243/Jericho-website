              ...
              <form className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      type="text"
                      className="w-full px-4 py-3 border border-border bg-white focus:outline-none focus:ring-2 focus:ring-primary"
                      placeholder="John"
                    />
                  </div>
                  <div>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {businessContacts.map((contact, index) => (
                <div key={index} className="bg-muted/20 border border-border p-6">
      ...
      <section className="py-16 md:py-20 bg-muted/30">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="bg-white border border-border aspect-video flex items-center justify-center">
